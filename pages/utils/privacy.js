...
class Privacy extends Component {
  render() {
    return (
      <div
        className="main-box main-content post-content col-12"
        style={{ padding: "20px 30px" }}
      >
        <h2>Privacy Policy of zurnal</h2>

        <p>
          zurnal operates the https://www.zurnal.co website, which provides the
          SERVICE.
        </p>
        <p>
          This page is used to inform website visitors regarding our policies
          with the collection, use, and disclosure of Personal Information if
          anyone decided to use our Service, the zurnal website.
        </p>
        <p>
        ...
        <p>
          ...
          Terms and Conditions, which is accessible at https://www.zurnal.co,
        ...
        <p>
          ...
          This Log Data may include information such as your computer&rsquo;s
        ...
        <p>
          ...
          website that you visit and are stored on your computer&rsquo;s hard
          drive.
        </p>
        <p>
